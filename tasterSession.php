...
<html lang="en">
    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3">Taster Session
        <small>Have a go at Climbing</small>
      </h1>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <img class="img-fluid" src="/assets/img/tasterSession750x500.jpg" alt="Climbing Taster Sessions">
        </div>

        <div class="col-md-4">
          <h3 class="my-3">Taster Climbing Session</h3>
