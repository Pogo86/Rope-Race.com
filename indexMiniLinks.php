<div class="row">
	<div class="col-lg-4 col-sm-6 portfolio-item">
		<div class="card h-100">
			<a href="miniMonkeys"><img class="card-img-top" src="assets/img/miniMonkeys700x400.jpg" alt="Mini Monkeys 5 Year old Climbing Club"></a>
			<div class="card-body">
				<h4 class="card-title">
					<a href="miniMonkeys">Mini Monkeys</a>
				</h4>
	...
	<div class="col-lg-4 col-sm-6 portfolio-item">
		<div class="card h-100">
			<a href="beginnersClimbing"><img class="card-img-top" src="assets/img/beginners700x400.jpg" alt="The best Beginners Climbing Course in the UK"></a>
			<div class="card-body">
				<h4 class="card-title">
	...
	<div class="col-lg-4 col-sm-6 portfolio-item">
		<div class="card h-100">
			<a href="rockAcademy"><img class="card-img-top" src="assets/img/rockAcademy700x400.jpg" alt="Under 18's Competition climbing team for gifted and talented climbers"></a>
			<div class="card-body">
				<h4 class="card-title">
	...
	<!--<div class="col-lg-4 col-sm-6 portfolio-item">
		<div class="card h-100">
			...
			<div class="card-body">
				<h4 class="card-title">
					<a href="functionRoom">Function Room Hire</a>
				</h4>
	...
	<div class="col-lg-4 col-sm-6 portfolio-item">
		<div class="card h-100">
			...
			<div class="card-body">
				<h4 class="card-title">
					<a href="holidayClub">Holiday Adventure Club</a>
				</h4>
