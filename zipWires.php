...
<?php $alsoLikeLink3="abseils";?>
<?php $alsoLikeImg3="charityAbseils";?>
...
<html lang="en">
    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3">Charity Zip Wire Events
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active">Charity Zip Wires</li>
      </ol>
      ...
      <div class="row">
        ...
        <div class="col-md-8">
          <img class="img-fluid" src="/assets/img/zipWire750x500.jpg" alt="">
        </div>

        <div class="col-md-4">
          <h3 class="my-3">Charity Zip Wire Events</h3>
